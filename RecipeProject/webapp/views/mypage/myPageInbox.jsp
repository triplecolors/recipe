...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2">
            <button type="button"  class="btn btn-danger btn-sm btn-block" role="button" 
              				onclick="location.href='${ pageContext.request.contextPath}/sendmsg.sm?mSender='"+${member.uno}>메일 쓰기</button>
            <hr />
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="${ pageContext.request.contextPath}/receivemsg.rm?mReceiver="+${member.unick}"> 받은메일함</a>
                </li>
