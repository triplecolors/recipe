...
<header>
<nav class="navbar navbar-expand-lg navbar-light"  style="background-color: rgba(9, 113, 204, 0.3);">
  <a class="navbar-brand" href="${ pageContext.request.contextPath }/views/admin/adminMain.jsp">레시피를 부탁해</a>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">레시피 글 관리</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">레시피 카테고리 관리</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">공지사항 관리</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">QnA 관리</a>
      </li>
    </ul>
